...
# de error. Este ejercicio utiliza otro enfoque del problema: la asociación (ya sea composición o agregación). 
# Enunciado: comenzando con el mismo código que el ejercicio sobre herencia múltiple, cree una clase 
# que agrupe el comportamiento común entre las clases Ventana y ParedCortina.
